...
def GRm6A():
    seqLength = 41
    num_nodes = 13      # # maxNumAtoms
    num_features = 15   # # according to the number of features of each atom, which features used can be self-define
    ...
    # The probability of samples being a m6A site
